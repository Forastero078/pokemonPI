...
export default function Detail(props) {
    ...
    useEffect(() => {
        ...
        return async function () {
            try {
                const response = await axios.get(`https://pokeapi.co/api/v2/pokemon/${detailId}`);
        ...
        <div className={styles.popup}>
            ...
            <div className={styles.detail}>
                ...
                <div className={styles.info}>
                    ...
                    <p className={styles.type}><p className={styles.type2}>Pokemón type's: </p>{types && types.map((element) => {
